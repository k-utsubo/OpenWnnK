    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a =
            context.obtainStyledAttributes(
                attrs, StyleableLoader.KeyboardView, defStyle, R.style.WnnKeyboardView);
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == StyleableLoader.KeyboardView_keyBackground) {
                mKeyBackground = a.getDrawable(attr);
                break;
            }
            if (attr == StyleableLoader.KeyboardView_verticalCorrection) {
                mVerticalCorrection = a.getDimensionPixelOffset(attr, 0);
                break;
            }
            if (attr ==  StyleableLoader.KeyboardView_keyPreviewLayout) {
                previewLayout = a.getResourceId(attr, 0);
                break;
            }
            if (attr ==  StyleableLoader.KeyboardView_keyPreviewOffset) {
                mPreviewOffset = a.getDimensionPixelOffset(attr, 0);
                break;
            }
            if (attr ==  StyleableLoader.KeyboardView_keyPreviewHeight) {
                mPreviewHeight = a.getDimensionPixelSize(attr, 80);
                break;
            }
            if (attr ==  StyleableLoader.KeyboardView_keyTextSize ) {
                mKeyTextSize = a.getDimensionPixelSize(attr, 18);
                break;
            }
            if (attr == StyleableLoader.KeyboardView_keyTextColor) {
                mKeyTextColor = a.getColor(attr, 0xFF000000);
                break;
            }
            if (attr == StyleableLoader.KeyboardView_labelTextSize) {
                mLabelTextSize = a.getDimensionPixelSize(attr, 14);
                break;
            }
            if (attr == StyleableLoader.KeyboardView_popupLayout) {
                mPopupLayout = a.getResourceId(attr, 0);
                break;
            }
            if (attr == StyleableLoader.KeyboardView_shadowColor) {
                mShadowColor = a.getColor(attr, 0);
                break;
            }
            if (attr == StyleableLoader.KeyboardView_shadowRadius) {
        ...
        a = mContext.obtainStyledAttributes(
                StyleableLoader.Theme);
        mBackgroundDimAmount = a.getFloat(StyleableLoader.Theme_backgroundDimAmount, 0.5f);

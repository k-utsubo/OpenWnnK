...
public class Keyboard {
    ...
    public static class Row {
        ...
        public Row(Resources res, Keyboard parent, XmlResourceParser parser) {
            ...
            TypedArray a = res.obtainAttributes(Xml.asAttributeSet(parser),
                    StyleableLoader.Keyboard);
            defaultWidth = getDimensionOrFraction(a,
                    StyleableLoader.Keyboard_keyWidth,
                    parent.mDisplayWidth, parent.mDefaultWidth);
            defaultHeight = getDimensionOrFraction(a,
                    StyleableLoader.Keyboard_keyHeight,
                    parent.mDisplayHeight, parent.mDefaultHeight);
            defaultHorizontalGap = getDimensionOrFraction(a,
                    StyleableLoader.Keyboard_horizontalGap,
                    parent.mDisplayWidth, parent.mDefaultHorizontalGap);
            verticalGap = getDimensionOrFraction(a,
                    StyleableLoader.Keyboard_verticalGap,
                    parent.mDisplayHeight, parent.mDefaultVerticalGap);
            a.recycle();
            a = res.obtainAttributes(Xml.asAttributeSet(parser),
                    StyleableLoader.Keyboard_Row);
            rowEdgeFlags = a.getInt(StyleableLoader.Keyboard_Row_rowEdgeFlags, 0);
            mode = a.getResourceId(StyleableLoader.Keyboard_Row_keyboardMode,
                    0);
        }
    }
    ...
    public static class Key {
        ...
        public Key(Resources res, Row parent, int x, int y, XmlResourceParser parser) {
            ...
            a.recycle();
            a = res.obtainAttributes(Xml.asAttributeSet(parser),
                    StyleableLoader.Keyboard_Key);
            this.x += gap;
            TypedValue codesValue = new TypedValue();
            a.getValue(StyleableLoader.Keyboard_Key_codes,
                    codesValue);
            ...
            iconPreview = a.getDrawable(StyleableLoader.Keyboard_Key_iconPreview);
            if (iconPreview != null) {
                iconPreview.setBounds(0, 0, iconPreview.getIntrinsicWidth(),
                        iconPreview.getIntrinsicHeight());
            }
            popupCharacters = a.getText(
                    StyleableLoader.Keyboard_Key_popupCharacters);
            popupResId = a.getResourceId(
                    StyleableLoader.Keyboard_Key_popupKeyboard, 0);
            repeatable = a.getBoolean(
                    StyleableLoader.Keyboard_Key_isRepeatable, false);
            modifier = a.getBoolean(
                    StyleableLoader.Keyboard_Key_isModifier, false);
            sticky = a.getBoolean(
                    StyleableLoader.Keyboard_Key_isSticky, false);
            edgeFlags = a.getInt(StyleableLoader.Keyboard_Key_keyEdgeFlags, 0);
            edgeFlags |= parent.rowEdgeFlags;

            icon = a.getDrawable(
                    StyleableLoader.Keyboard_Key_keyIcon);
            if (icon != null) {
                icon.setBounds(0, 0, icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
            }
            label = a.getText(StyleableLoader.Keyboard_Key_keyLabel);
            text = a.getText(StyleableLoader.Keyboard_Key_keyOutputText);
